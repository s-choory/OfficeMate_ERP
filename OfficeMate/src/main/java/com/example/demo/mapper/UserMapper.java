...
public interface UserMapper {
	...
	@Select("SELECT * FROM users WHERE departmentId = #{departmentId}" + "ORDER BY \n" + "    CASE \n"
			+ "        WHEN userRank = '사장' THEN 1" + "        WHEN userRank = '부사장' THEN 2"
			+ "        WHEN userRank = '상무' THEN 3" + "        WHEN userRank = '부장' THEN 4"
			+ "        WHEN userRank = '차장' THEN 5" + "        WHEN userRank = '과장' THEN 6"
			+ "        WHEN userRank = '대리' THEN 7" + "        ELSE 8 END, userId")
	...
	@Select("SELECT * FROM users\n" + "ORDER BY \n" + "    CASE \n" + "        WHEN userRank = '사장' THEN 1"
			+ "        WHEN userRank = '부사장' THEN 2" + "        WHEN userRank = '상무' THEN 3"
			+ "        WHEN userRank = '부장' THEN 4" + "        WHEN userRank = '차장' THEN 5"
			+ "        WHEN userRank = '과장' THEN 6" + "        WHEN userRank = '대리' THEN 7" + "        ELSE 8"
			+ "    END," + "    userId")
